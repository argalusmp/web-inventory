                        ...
                        <div class="p-5">
                            <div class="text-center">
                                ...
                                <?php if (session()->getFlashdata('error_register')) : ?>
                                    <p><?= session()->getFlashdata('error_register') ?></p>
                                <?php endif; ?>
                            </div>
                            <form method="post" action="<?= base_url('/register/akun') ?>" class="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="nohp" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="No hp">
                                    </div>
                                </div>
