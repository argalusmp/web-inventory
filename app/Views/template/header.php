    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('/') ?>">
                ...
                <div class="sidebar-brand-text mx-3">Bajuskuy</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTransaksi" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url("barang/masuk") ?>">Barang Masuk</a>
                        <a class="collapse-item" href="<?= base_url("barang/keluar") ?>">Barang Keluar</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Stock Menu -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url("barang/stock") ?>">
            ...
            <!-- Kondisi jika user admin login maka menampilkan menu berikut -->
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseMasterData" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="<?= base_url('/barang/barang') ?>">Barang</a>
                            <a class="collapse-item" href="<?= base_url('/supplier/supplier') ?>">Supplier</a>
                        </div>
                    </div>
                </li>
            <?php
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="<?= base_url(" img/template-img/undraw_profile.svg") ?>">
                            </a>
